...
import 'package:aize/widgets/sale_item.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class SaleManager extends GetView {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: BackButton(),
        title: Text('Gestion des ventes',style: TextStyle(color: Colors.white),),
        actions: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            ...
                            child: Text('Trier par',style: TextStyle(fontSize: 18.sp,color: Colors.white),),
                        ),
                        Container(
                            height: 40.h,
                            width: 0.3.sw,
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: <String>['Date', 'Prix'].map((String value) {
